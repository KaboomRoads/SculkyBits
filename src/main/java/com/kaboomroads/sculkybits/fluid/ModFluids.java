...
public class ModFluids {
    ...
    public static final RegistryObject<LiquidBlock> SCULK_FLUID_BLOCK = ModBlocks.registerBlock("sculk_fluid", () -> new LiquidBlock(SCULK_FLUID, BlockBehaviour.Properties.of(Material.WATER).noCollission().strength(100)));
